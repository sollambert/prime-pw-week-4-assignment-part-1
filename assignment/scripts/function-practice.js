...
let num3 = 4;
console.log(`Multiply numbers (${num1}, ${num2}, ${num3}):`, multiplyThree(num1, num2, num3));
...
console.log(`Last of array [${arrayNums}]:`, getLast(arrayNums));
...
let num4 = 3;
console.log(`Value ${num4} exists in array [${arrayNums}]:`, find(num4, arrayNums));
...
console.log(`Sum all indices of [${arrayNums}]: `, sumAll(arrayNums));
